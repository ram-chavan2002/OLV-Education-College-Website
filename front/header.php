...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title : 'OLV EDUCATION'; ?></title>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600&family=Orbitron:wght@400;700;900&display=swap" rel="stylesheet">
    <!-- Move links AFTER header3.php loads -->
...
<header class="olv-header" id="olvHeader">
    <div class="container">
        ...
        <nav class="olv-nav" aria-label="Main navigation">
            <ul class="olv-menu">
                <li><a class="<?php echo olv_active('olv-school.php'); ?>" href="olv-school.php">Home</a></li>
                <li><a class="<?php echo olv_active('about.php'); ?>" href="about.php">About Us</a></li>
                <li><a class="<?php echo olv_active('courses.php'); ?>" href="courses.php">Courses</a></li>
                <li><a class="<?php echo olv_active('teachers.php'); ?>" href="teachers.php">Teachers & Faculties</a></li>
                <li><a class="<?php echo olv_active('gallery.php'); ?>" href="gallery.php">Gallery</a></li>
                ...
                <li class="olv-dd has-dropdown">
                    ...
                    <div class="olv-dd-panel dropdown-menu">
                        ...
                        <a class="<?php echo olv_active('complaintt.php'); ?>" href="complaintt.php">Complaint</a>
                        <a class="<?php echo olv_active('contactUs.php'); ?>" href="ContactUs.php">Contact Us</a>
                    </div>
                </li>
            </ul>
...
<div class="olv-mmenu" id="olvMobileMenu">
    <a class="<?php echo olv_active('olv-school.php'); ?>" href="olv-school.php">Home</a>
    <a class="<?php echo olv_active('about.php'); ?>" href="about.php">About Us</a>
    <a class="<?php echo olv_active('courses.php'); ?>" href="courses.php">Courses</a>
    <a class="<?php echo olv_active('teachers.php'); ?>" href="teachers.php">Teachers & Faculties</a>
    <a class="<?php echo olv_active('gallery.php'); ?>" href="gallery.php">Gallery</a>
    <a class="<?php echo olv_active('register.php'); ?>" href="register.php">Register</a>
    <a class="<?php echo olv_active('complaintt.php'); ?>" href="complaintt.php">Complaint</a>
    <a class="<?php echo olv_active('ContactUs.php'); ?>" href="ContactUs.php">Contact Us</a>
