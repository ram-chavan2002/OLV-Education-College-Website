    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .olv-brand-badge{
            ...
            display: grid;
            place-items: center;
            background: linear-gradient(135deg, var(--olv-gold), #b9872f);
        ...
        .olv-dd:hover .olv-dd-panel,
        .olv-dd.open .olv-dd-panel{ 
            opacity: 1;
            visibility: visible;
        ...
        .olv-header.scrolled .olv-dd-panel a:hover {
            background: rgba(212,163,77,0.20);
        ...
        .olv-header.scrolled .olv-menu a{ color: #fff; opacity: 0.95; }
...
<header class="olv-header" id="olvHeader">
    <div class="container">
        ...
        <nav class="olv-nav" aria-label="Main navigation">
            <ul class="olv-menu">
                <li><a class="<?php echo olv_active('home3.php'); ?>" href="home3.php">Home</a></li>
                <li><a class="<?php echo olv_active('about3.php'); ?>" href="about3.php">About Us</a></li>
                <li><a class="<?php echo olv_active('courses3.php'); ?>" href="courses3.php">Courses</a></li>
                <li><a class="<?php echo olv_active('teachers3.php'); ?>" href="teachers3.php">Teachers & Faculties</a></li>
                <li><a class="<?php echo olv_active('Gallery3.php'); ?>" href="Gallery3.php">Gallery</a></li>

                <li class="olv-dd">
                    <a href="#" onclick="toggleMoreDropdown(event)">More ▾</a>
                    <div class="olv-dd-panel">
                        <a class="<?php echo olv_active('register.php'); ?>" href="register.php">Register</a>
                        <a class="<?php echo olv_active('complaint3.php'); ?>" href="complaint3.php">Complaint</a>
                        <a class="<?php echo olv_active('ContactUs3.php'); ?>" href="ContactUs3.php">Contact Us</a>
                    </div>
                </li>
            </ul>
...
<div class="olv-mmenu" id="olvMobileMenu">
    <a class="<?php echo olv_active('home3.php'); ?>" href="home3.php">Home</a>
    <a class="<?php echo olv_active('about3.php'); ?>" href="about3.php">About Us</a>
    <a class="<?php echo olv_active('courses3.php'); ?>" href="courses3.php">Courses</a>
    <a class="<?php echo olv_active('teachers3.php'); ?>" href="teachers3.php">Teachers & Faculties</a>
    <a class="<?php echo olv_active('Gallery3.php'); ?>" href="Gallery3.php">Gallery</a>
    <a class="<?php echo olv_active('register.php'); ?>" href="register.php">Register</a>
    <a class="<?php echo olv_active('complaint3.php'); ?>" href="complaint3.php">Complaint</a>
    <a class="<?php echo olv_active('ContactUs3.php'); ?>" href="ContactUs3.php">Contact Us</a>
...
<script>
    ...
    // FIXED: More dropdown toggle function
    function toggleMoreDropdown(event) {
        event.preventDefault();
        event.stopPropagation();
        const dd = event.currentTarget.closest('.olv-dd');
    ...
    document.addEventListener('click', function(e) {
        const moreDd = document.querySelector('.olv-dd');
        if (!moreDd.contains(e.target) && moreDd.classList.contains('open')) {
